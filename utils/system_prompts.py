...
generate_insights_prompt = {
    ...
    "text": "The input is a JSON object containing app IDs as keys and lists of user reviews as values. "
            ...
            "    ]\n"
            "}\n\n"
            "Analyze these reviews to extract insights about all the apps. Identify common user pain points, insights "
            "and suggestions for improvement. For each insight, provide:\n"
            "1. A title summarizing the issue or positive aspect.\n"
            "2. The total number of users who mentioned this issue.\n"
            "3. A list of all user quotes related to this issue. The number of quotes should match the user count "
